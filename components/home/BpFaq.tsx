...
const QA: { q: string; a: React.ReactNode }[] = [
  ...
  { q: "What do I get back?", a: <>One of five answers: confirmed, refuted, invalidated, can&apos;t-confirm, or confirmed-with-caveats — plus the reason, the fix when something&apos;s missing, and <b>a one-command replay anyone can run.</b></> },
  { q: "Can it block a PR from merging?", a: <>Yes — that&apos;s a distinct surface. Calma runs as a <b>required PR check</b>, a blocking gate rather than a comment-bot opinion: a refuted or invalidated number fails the check, so a wrong number can&apos;t be merged. <b>Prove your own numbers before you ship.</b></> },
  { q: "Does my code or data leave my machine?", a: <>No. Everything runs locally, inside a sandbox that blocks the network. <b>Nothing is uploaded, ever.</b></> },
