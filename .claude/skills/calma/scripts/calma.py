...
def verify(target, claim=None, metric=None, run_id="run", force=False, check_determinism=False,
           trust="own-code", timeout=None, isolation=None, restore=False, cross_engine=False):
    ...
    if block_finding is None and not force and not check_determinism and not cross_engine:
