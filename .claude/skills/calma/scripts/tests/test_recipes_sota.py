...
KINDS = {
    ...
    "bs_speed": lambda a: N.bs_speed(a["S"], a["K"], a["T"], a["sigma"], a["r"], a["qty"], a["is_call"]),
    ...
    "realized_variance": lambda a: N.realized_variance(a["rets"]),
    ...
    "concentration_ratio": lambda a: N.concentration_ratio(a["xs"], a["k"]),
