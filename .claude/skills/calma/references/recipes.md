# Recipe catalog (representative families across all 557 SOTA-validated recipes)

This documents the binding tags, conventions, and data layouts by FAMILY with representative
recipes; the authoritative, complete id list is `calma recipes` (557 ids across 16 families).
