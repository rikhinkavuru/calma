# Recipe catalog (representative families across all 532 SOTA-validated recipes)

This documents the binding tags, conventions, and data layouts by FAMILY with representative
recipes; the authoritative, complete id list is `calma recipes` (532 ids across 16 families).
