...
/* THE PROBLEM — the one real story, reused chart, now in the continuous column. */
export function BpProblem() {
  const [ref, seen] = useInView<HTMLDivElement>(0.3);

  return (
    <div className="bp-block" id="problem">
      <Reveal>
        <div className="bp-head">
          <span className="bp-kicker">The problem</span>
          <h2 className="bp-h2">A wrong number looks exactly like a <span className="am">right one.</span></h2>
          <p className="bp-lead">
      ...
      <div className="bp-prob" ref={ref}>
        <Reveal>
          <div className="panel">
            ...
            >
              ...
              <polyline className="claimline" style={{ ["--len" as string]: 700 }} points="64,254 120,250 176,244 232,235 288,221 340,203 392,179 444,144 496,100 540,56" />
              <polyline points="540,56 640,42 740,32 830,26" fill="none" stroke="rgba(233,221,196,.22)" strokeWidth="1.4" strokeDasharray="3 7" />
              <polyline className="realline" style={{ ["--len" as string]: 340 }} points="540,254 580,259 620,253 660,264 700,268 740,263 780,272 830,275" />
            </svg>
          </div>
        </Reveal>
        ...
        <Reveal delay={180}>
          <div>
            <p className="bp-lead">Nobody re-checks these numbers. <b>They get believed, shipped, and spent on.</b></p>
            <div className="figs">
              <div className="fig">
